...
class Plan(BaseModel):
    ...
    description: str = Field(description="A oneline description of the app to be built, ex. 'A web application for managing personal finances'")
    techstack: str = Field(description="The tech stack to be used for the app, e.g. 'python', 'javascript', 'react', 'flask', etc.")
    features: list[str] = Field(description="A list of features that the app should have, ex. 'user authentication', 'data visualization', etc.")
